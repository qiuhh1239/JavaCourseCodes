...
import io.qhh.rpcfx.api.Filter;
import io.qhh.rpcfx.api.LoadBalancer;
import io.qhh.rpcfx.api.Router;
import io.qhh.rpcfx.api.RpcfxRequest;
import io.qhh.rpcfx.api.RpcfxResponse;
...
public final class Rpcfx {
    ...
    public static class RpcfxInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] params) throws Throwable {
            ...
            System.out.println(this.getClass()+"--->"+response.getResult().toString());
