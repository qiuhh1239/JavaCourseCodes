...
import io.qhh.rpcfx.api.ServiceProviderDesc;
import io.qhh.rpcfx.demo.api.OrderService;
import io.qhh.rpcfx.demo.api.UserService;
import io.qhh.rpcfx.server.RpcfxInvoker;
...
//		registerService(client, orderService);
	...
	//@Bean(name = "io.qhh.rpcfx.demo.api.UserService")
	@Bean
	public UserService createUserService(){
		return new UserServiceImpl();
	}

	//@Bean(name = "io.qhh.rpcfx.demo.api.OrderService")
	@Bean
